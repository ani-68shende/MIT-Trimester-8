...
public:
    ...
    {
        return this->EP()->R_xor_with(key)->shrink()->P4()->R_xor_with_L();
    }
    void print()
    {
        print_vector(bits);
...
public:
    ...
    void encrypt()
    {
        ...
        cout << endl
             << "PLain Text:" << endl;
        print_table_header();
        ciphertext = temp_plaintext->IP()->complex(key1)->swap()->complex(key2)->INVERSE_IP();
    }
    void decrypt()
    {
        cout << endl
        ...
        cout << endl
             << "PLain Text:" << endl;
        print_table_header();
        ciphertext = temp_plaintext->IP()->complex(key2)->swap()->complex(key1)->INVERSE_IP();
    }
